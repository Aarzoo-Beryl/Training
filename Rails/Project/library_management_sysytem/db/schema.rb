...
# migrations use external dependent or application code.
#
# It's strongly recommended that you check this file into your version control system.

ActiveRecord::Schema[7.1].define(version: 2024_04_29_054805) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "books", comment: "contains list of all the books present in library", force: :cascade do |t|
    t.string "title"
    t.string "author"
  ...
  create_table "practice_tables", primary_key: ["first_column", "second_column"], force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.check_constraint "first_column > 0", name: "positive_values"
  end
